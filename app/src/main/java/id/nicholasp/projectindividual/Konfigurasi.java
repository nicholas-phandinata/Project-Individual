...
public class Konfigurasi {
    ...
    public static final String URL_GET_ALL_INS = "http://192.168.1.100/inixindo/instruktur/tr_datas_instruktur.php";
    public static final String URL_GET_DETAIL_INS = "http://192.168.1.100/inixindo/instruktur/tr_detail_instruktur.php?id_ins=";
    public static final String URL_ADD_INS = "http://192.168.1.100/inixindo/instruktur/tr_add_instruktur.php";
    public static final String URL_UPDATE_INS = "http://192.168.1.100/inixindo/instruktur/tr_update_instruktur.php";
    public static final String URL_DELETE_INS = "http://192.168.1.100/inixindo/instruktur/tr_delete_instruktur.php?id_ins=";

    public static final String URL_GET_ALL_MAT = "http://192.168.1.100/inixindo/materi/tr_datas_materi.php";
    public static final String URL_GET_DETAIL_MAT = "http://192.168.1.100/inixindo/materi/tr_detail_materi.php?id_mat=";
    public static final String URL_ADD_MAT = "http://192.168.1.100/inixindo/materi/tr_add_materi.php";
    public static final String URL_UPDATE_MAT = "http://192.168.1.100/inixindo/materi/tr_update_materi.php";
    public static final String URL_DELETE_MAT = "http://192.168.1.100/inixindo/materi/tr_delete_materi.php?id_mat=";

    public static final String URL_GET_ALL_PST = "http://192.168.1.100/inixindo/peserta/tr_datas_peserta.php";
    public static final String URL_GET_DETAIL_PST = "http://192.168.1.100/inixindo/peserta/tr_detail_peserta.php?id_pst=";
    public static final String URL_ADD_PST = "http://192.168.1.100/inixindo/peserta/tr_add_peserta.php";
    public static final String URL_UPDATE_PST = "http://192.168.1.100/inixindo/peserta/tr_update_peserta.php";
    public static final String URL_DELETE_PST = "http://192.168.1.100/inixindo/peserta/tr_delete_peserta.php?id_pst=";
