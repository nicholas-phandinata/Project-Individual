...
public class Konfigurasi {
    ...
    public static final String URL_GET_DETAIL_MAT = "http://192.168.1.8/inixindo/materi/tr_detail_materi.php?id_mat=";
    public static final String URL_ADD_MAT = "http://192.168.1.8/inixindo/materi/tr_add_materi.php";
    public static final String URL_UPDATE_MAT = "http://192.168.1.8/inixindo/materi/tr_update_materi.php";
    public static final String URL_DELETE_MAT = "http://192.168.1.8/inixindo/materi/tr_delete_materi.php?id_mat=";

    public static final String URL_GET_ALL_PST = "http://192.168.1.8/inixindo/peserta/tr_datas_peserta.php";
    public static final String URL_GET_DETAIL_PST = "http://192.168.1.8/inixindo/peserta/tr_detail_peserta.php?id_pst=";
    public static final String URL_ADD_PST = "http://192.168.1.8/inixindo/peserta/tr_add_peserta.php";
    public static final String URL_UPDATE_PST = "http://192.168.1.8/inixindo/peserta/tr_update_peserta.php";
    public static final String URL_DELETE_PST = "http://192.168.1.8/inixindo/peserta/tr_delete_peserta.php?id_pst=";

    public static final String URL_GET_ALL_KLS = "http://192.168.1.8/inixindo/kelas/tr_datas_kelas.php";
    public static final String URL_GET_DETAIL_KLS = "http://192.168.1.8/inixindo/kelas/tr_detail_kelas.php?id_kls=";
    public static final String URL_ADD_KLS = "http://192.168.1.8/inixindo/kelas/tr_add_kelas.php";
